...
public class RestContextCaseId {
    ...
    public class TypeUrl {
        public static final String PROCESSINSTANCIATION = "PROCESSINSTANCIATION" ; 
		public static final String CASEOVERVIEW = "CASEOVERVIEW" ; 
		public static final String TASKEXECUTION = "TASKEXECUTION"; 
		public static final String UNKNOW = "UNKNOW";
    };

    String detectTypeUrl = TypeUrl.UNKNOW;
    ...
    String scopeSearch = ScopeSearch.DEFAULT;
	...
	boolean abbreviateSMTTopicData=false;
	RestContextAbbreviateData abbrDataDef = null;
    ...
    public class DateFormat {
		...
		public static final String DATEJSON = "DATEJSON";
	};
    private String defaultDateFormat = DateFormat.DATELONG;
	...
	{
		return Boolean.valueOf( detectTypeUrl == TypeUrl.CASEOVERVIEW);
	}
	public boolean isProcessInstanciation()
	{
		return Boolean.valueOf( detectTypeUrl == TypeUrl.PROCESSINSTANCIATION );
	}
	public boolean isTaskExecution()
	{
		return Boolean.valueOf( detectTypeUrl == TypeUrl.TASKEXECUTION);
	}
	public boolean isCaseArchived()
	{
		return archivedProcessInstance !=null;
	}
	public boolean isAbbreviateSMTTopicData () {
		return abbreviateSMTTopicData;
	}
	public RestContextAbbreviateData getAbbrDataDef () {
		if (abbreviateSMTTopicData) {
			return abbrDataDef;
		}
		else {
			return null;
    ...
    private void internalDecodeParameters()
    {
        ...
        {
            if (ScopeSearch.ROOT.equals(  getOneParameter("scope")))
                scopeSearch=ScopeSearch.ROOT;
            if (ScopeSearch.DEFAULT.equals(  getOneParameter("scope")))
		...
		String astd = getOneParameter("astd");
		if (astd != null) {
			abbreviateSMTTopicData = true;
			abbrDataDef = new RestContextAbbreviateData(astd);
		}
		else {
			abbreviateSMTTopicData = false;
			abbrDataDef = null;
		}
    ...
    /*                                                                                  */
    /* -------------------------------------------------------------------------------- */
	public void logTrace (String traceStr) {
		if (isLogTrace) {
			logger.info("<*><*><*><*><*><*><*><*> TRACE: "+traceStr);
			bufferLog.append(traceStr+";");
		}
	}
