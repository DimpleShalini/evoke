...
public class RestContextTransformData {
    ...
    {
		contextCaseId.logTrace ("transform: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
        if (pilotDataMap==null)
            return;

        Object pilotAction = pilotDataMap.get( varName );
		if (pilotAction != null) {
			contextCaseId.logTrace ("transform: pilotAction type["+pilotAction.getClass().getName()+"]; completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
		}
		else {
			contextCaseId.logTrace ("transform: pilotAction type[null]; completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
		}
        ...
        {
			contextCaseId.logTrace("transform pilotAction instanceof Map: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
            ...
            {
				contextCaseId.logTrace ("transform varValueTransformed instanceof Map: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
                trace +=";Data=MAP";
            ...
            {
				contextCaseId.logTrace ("transform varValueTransformed instanceof List: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
                trace+=";Data=LIST";
            ...
            {
				contextCaseId.logTrace ("transform varValue == null: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
        ...
        else
        {
			...
			contextCaseId.logTrace("transform pilotAction NOT instanceof Map: isAllowed["+isAllowed+"]; completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
        ...
        {
			contextCaseId.logTrace ("transform varValue instanceof Enum: completeName["+completeName+"]; varName["+varName+"]; varType["+varValue.getClass().getName()+"]");
            trace+= ";ENUM Detected";
    ...
    {
		contextCaseId.logTrace ("transformSingleValue: varName["+varName+"]; varType["+data.getClass().getName()+"]");
        ...
        {
			contextCaseId.logTrace ("transformSingleValue USING Date TYPE!!!: varName["+varName+"]; varType["+data.getClass().getName()+"]");
            dataDate= (Date) data;
        }
		if (data==null)
		{
        ...
        {
			contextCaseId.logTrace ("transformSingleValue returning after conversion of date: varName["+varName+"]; varType["+data.getClass().getName()+"]");
        ...
        if (data!=null && data instanceof List)
        {
			...
			contextCaseId.logTrace ("transformSingleValue RETURNING: varName["+varName+"]; varType["+data.getClass().getName()+"]");
