...
public class Global_Brand_NameTable extends TableBase {
	 ...
	 * definition
	 */
	public Global_Brand_NameTable () {
		super (null, "global_brand_name", Global_Brand_NameRow.COLS, true, false);
		...
		Global_Brand_NameRow.COLS = this.col_def;
	}
	 ...
	 */
	public Global_Brand_NameTable (Database db) {
		super (db, "global_brand_name", Global_Brand_NameRow.COLS, true, false);
	...
	public void readRow(ResultSet rs) throws SQLException {
		table_rows.add(new Global_Brand_NameRow(rs));
	}
	 ...
	 * @throws SQLException
	 */
	public void getAllGlobalBrandNamesForAProjectCode (String project_code) throws SQLException {
		...
		try {
			...
			logger.error("SQL Exception thrown in getAllGlobalBrandNamesForAProjectCode");
